...
-----------------------------------------------------
/*
VIEW를 통한 DML은 가능하긴 하지만 , 몇가지 제약상항이 있습니다.
1. 가상열이면 안됩니다.
...
VALUES (1000,'DEMO HONG','DEMO IT','DEMO IT PRO');
--2.JOIN을 이용한 테이블인 경우에도 안됩니다.
INSERT INTO EMPS_VIEW(DEPARTMENT_NAME) VALUES ('DEMO');
--3.원본테이블 NOT NULL제약이 있다면 안됩니다.
INSERT INTO EMPS_VIEW(EMPLOYEE_ID,JOB_TITLE) VALUES(100,'TEST');
