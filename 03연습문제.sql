...
SELECT FIRST_NAME , LAST_NAME , HIRE_DATE , SALARY FROM EMPLOYEES WHERE HIRE_DATE BETWEEN '02/12/31' AND '04/01/01';  
...
SELECT  LAST_NAME , SALARY , DEPARTMENT_ID FROM EMPLOYEES WHERE DEPARTMENT_ID = 60 ORDER BY SALARY;
...
SELECT  FIRST_NAME || LAST_NAME || '의 사원의 급여는' || SALARY ||'입니다' FROM EMPLOYEES WHERE FIRST_NAME = 'Steven' AND LAST_NAME='King';
