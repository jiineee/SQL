...
CREATE TABLE DEPT2 (
    ...
    DEPT_YN CHAR(1), --1BYTE고정문자형
    DEPT_DATE DATE,
    DEPT_BOBUS NUMBER(10,3) --10자리 , 소수부3자리 
);
...
--테이블 삭제 
DROP TABLE DEPT2;
--DROP TABLE DEPT2 CACASE 제약조건명 -- 제약조건FX도 삭제, 테이블도 삭제
...
INSERT INTO DEPTS2 VALUES(20,'HONG',SYSDATE,'01011111111',1000,500);
...
CREATE TABLE MY(
    M_NAME VARCHAR2(3) CONSTRAINT M_NAME NOT NULL,
    M_NUM NUMBER(1) CONSTRAINT MEM_MEMNUM_PK PRIMARY KEY ,
    REG_DATE DATE CONSTRAINT MEM_REGDATE_UK UNIQUE,
    GENDER CHAR CONSTRAINT GENDER CHECK(GENDER='M' OR GENDER='F'),
...
SELECT M_NAME,
       ...
       STREET_ADDRESS,
       L.LOCATION_ID
FROM MY M INNER JOIN LOCATIONS L ON M.LOCA = L.LOCATION_ID
ORDER BY M_NUM;
