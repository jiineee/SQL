...
SELECT * FROM EMPLOYEES WHERE DEPARTMENT_ID <> 4800; --같지않다
...
SELECT * FROM EMPLOYEES WHERE (JOB_ID = 'IT_PROG' OR JOB_ID = 'FI_MGR') AND SALARY >= 6000; --FI,IT중 6000이상인사람
